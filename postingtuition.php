...
<body>
 ...
 <div class="pr">POST TUITION<p>THEN HIRE</p></div>

 

 

<p class="word">STUDENT NAME</p><input type="text" name="stdnam"></p>
  <p> <span class="word">STUDENT GENDER &nbsp;</span>
...
<p class="word">SALARY</p><input type="text" name="slr">
