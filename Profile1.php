...
<body>
 ...
 <div class="pr">SIGN UP</div>
<p class="words"> <span class="word">SIGN UP AS &nbsp;</span>
TUTOR<input style="position: relative;" type="radio" name="signupas" value="tutor">
 GUARDIAN<input  style="position: relative;" type="radio" name="signupas" value="guardian"></p>
<p class="word"> NAME</p>
