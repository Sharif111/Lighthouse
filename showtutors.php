...
$sql='SELECT * FROM profiletutors LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
$result = mysqli_query($conn, $sql);
...
for ($page=1;$page<=$number_of_pages;$page++) {
 ...
 <?php 
  echo '<a href="showtutors.php?page=' . $page . '">' . $page . '</a> ';
